document.addEventListener("DOMContentLoaded", function () {
    // 공지사항 목록으로 돌아가는 버튼 클릭 이벤트 처리
    document.getElementById("backToNoticesButton").addEventListener("click", function () {
        window.location.href = "/notices.html"; // 공지사항 목록 페이지로 이동
    });
